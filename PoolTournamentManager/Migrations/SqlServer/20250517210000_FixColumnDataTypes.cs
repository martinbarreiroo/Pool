...
{
    /// <inheritdoc />
    public partial class FixColumnDataTypes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // This migration creates tables for SQL Server with proper data types
            // SQL Server uses uniqueidentifier for Guid/UUID
